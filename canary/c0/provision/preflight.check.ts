...
const env = {
  ...
  VOICE_C0_LIVEKIT_URL: 'wss://c0.livekit.cloud', VOICE_C0_LIVEKIT_API_KEY: fakeLiveKitKey(), VOICE_C0_LIVEKIT_API_SECRET: 'b'.repeat(32), VOICE_C0_LIVEKIT_SIP_HOST: 'c0.sip.livekit.cloud', VOICE_C0_LIVEKIT_TRUNK_ID: fakeSid('ST'), VOICE_C0_LIVEKIT_RULE_ID: fakeSid('SD'), VOICE_C0_LIVEKIT_MEDIA_ENCRYPTION: 'SIP_MEDIA_ENCRYPT_ALLOW',
